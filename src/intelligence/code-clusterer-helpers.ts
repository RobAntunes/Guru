...
export class CodeClustererHelpers {
  private inferResponsibilities(type: SemanticZoneType, names: string[]): string[] {
    const responsibilities: string[] = [];
    
    switch (type) {
      case 'feature':
        responsibilities.push('Business logic implementation', 'Feature workflow coordination');
        break;
      case 'ui':
