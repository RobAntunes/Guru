...
export const ENTRY_POINT_PATTERNS: EntryPointIndicator[] = [
  // Function name patterns
  {
    ...
    confidence: 0.95,
    weight: 1.0,
    description: "Function named main",
  },
  {
    type: "function_name",
    pattern: /^start$/i,
    confidence: 0.9,
    weight: 0.9,
    description: "Function named start",
  },
  {
    type: "function_name",
    pattern: /^init$/i,
    confidence: 0.85,
    weight: 0.8,
    description: "Function named init",
  },
  {
    type: "function_name",
    pattern: /^run$/i,
    confidence: 0.8,
    weight: 0.8,
    description: "Function named run",
  },
  {
    type: "function_name",
    pattern: /^bootstrap$/i,
    confidence: 0.8,
    weight: 0.7,
    description: "Function named bootstrap",
  },
  {
    type: "function_name",
    pattern: /^launch$/i,
    confidence: 0.75,
    weight: 0.7,
    description: "Function named launch",
  },
  {
    type: "function_name",
    pattern: /^app$/i,
    confidence: 0.7,
    weight: 0.6,
    description: "Function named app",
  },

  // File pattern indicators
  {
    type: "file_pattern",
    pattern: /index\.(js|ts|jsx|tsx)$/i,
    confidence: 0.85,
    weight: 0.8,
  ...
  },
  {
    ...
    confidence: 0.85,
    weight: 0.8,
    description: "Commander.js usage",
  },
  {
    type: "cli_usage",
    pattern: /yargs\./i,
  ...
  },
  {
    ...
    confidence: 0.8,
    weight: 0.7,
    description: "Minimist usage",
  },

  // Server patterns
  {
    type: "execution_pattern",
    pattern: /app\.listen\(/i,
    confidence: 0.9,
    weight: 0.9,
    description: "Express server listen",
  },
  {
    type: "execution_pattern",
    pattern: /server\.listen\(/i,
    confidence: 0.85,
    weight: 0.8,
    description: "HTTP server listen",
  },
  {
    type: "execution_pattern",
    pattern: /createServer\(/i,
    confidence: 0.8,
    weight: 0.8,
  ...
  {
    type: "execution_pattern",
    pattern: /if\s*\(\s*require\.main\s*===\s*module\s*\)/i,
    confidence: 0.95,
    weight: 1.0,
    description: "Main module check",
  },
  {
    type: "execution_pattern",
    pattern: /if\s*\(\s*import\.meta\.main\s*\)/i,
    confidence: 0.9,
    weight: 0.9,
    description: "ES module main check",
  },

  // Browser patterns
  {
    type: "execution_pattern",
    pattern: /window\.onload/i,
    confidence: 0.8,
    weight: 0.7,
    description: "Window onload handler",
  },
  {
    type: "execution_pattern",
    pattern:
      /document\.addEventListener\s*\(\s*['"](DOMContentLoaded|load)['"]/i,
    confidence: 0.8,
    weight: 0.8,
    description: "DOM ready handler",
  },
  {
    type: "execution_pattern",
    ...
    confidence: 0.75,
    weight: 0.7,
    description: "jQuery ready handler",
  },
  ...
  // Test patterns (lower confidence for entry points)
  {
    ...
    confidence: 0.3,
    weight: 0.3,
    description: "Test suite (not primary entry)",
  },
  {
    type: "execution_pattern",
    pattern: /it\s*\(/i,
    confidence: 0.2,
    weight: 0.2,
    description: "Test case (not primary entry)",
  },
  {
    type: "execution_pattern",
    pattern: /test\s*\(/i,
    confidence: 0.25,
    weight: 0.25,
    description: "Test function (not primary entry)",
  },
];
